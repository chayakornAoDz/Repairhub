...
<div class="grid">
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="menu">
      ...
      <a href="computers.php" class="<?= $curFile==='computers.php'?'active':'' ?>" title="ทะเบียนคอมพิวเตอร์">
        <span class="ico">🖥️</span><span class="lbl collapse-hide">ทะเบียนคอมพิวเตอร์</span>
      </a>
